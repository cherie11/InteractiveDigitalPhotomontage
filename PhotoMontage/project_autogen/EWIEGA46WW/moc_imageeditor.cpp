...
QT_MOC_LITERAL(4, 31, 9), // "ShowColor"
QT_MOC_LITERAL(5, 41, 8), // "setWidth"
QT_MOC_LITERAL(6, 50, 5), // "clear"
QT_MOC_LITERAL(7, 56, 8) // "saveEdit"

    },
    "ImageEditor\0sendEdit\0\0QPixmap*\0ShowColor\0"
    "setWidth\0clear\0saveEdit"
};
...
void ImageEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendEdit((*reinterpret_cast< QPixmap*(*)>(_a[1]))); break;
        case 1: _t->ShowColor(); break;
        case 2: _t->setWidth((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->clear(); break;
        case 4: _t->saveEdit(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ImageEditor::*_t)(QPixmap * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageEditor::sendEdit)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ImageEditor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ImageEditor.data,
      qt_meta_data_ImageEditor,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void ImageEditor::sendEdit(QPixmap * _t1)
{
